...
opensearch:
	docker run --rm --name opensearch-node -p 9200:9200 -p 9600:9600 -e "discovery.type=single-node" -e "OPENSEARCH_JAVA_OPTS=-Xms1g -Xmx1g" -e "OPENSEARCH_INITIAL_ADMIN_PASSWORD=xuYz3_cAXYh7" opensearchproject/opensearch:latest
